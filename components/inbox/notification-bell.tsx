  ...
  return (
    <div className="relative">
      ...
      {preview && (
        <aside
          role="status"
          className="fixed inset-x-3 top-16 z-50 origin-top rounded-(--radius-card) border border-line bg-card/95 p-4 shadow-card backdrop-blur-md reduce-transparency:bg-card reduce-transparency:backdrop-filter-none motion-safe:animate-sk-pop sm:absolute sm:inset-x-auto sm:end-0 sm:top-full sm:mt-2 sm:w-80"
        >
          <button
            type="button"
